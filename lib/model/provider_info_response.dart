// model/provider_info_response.dart
...
class ProviderInfoResponse {
  ...
  ProviderInfoResponse.fromJson(Map<String, dynamic> json) {
    ...
    handymanImageList = json['handyman_image'] != null
        ? json['handyman_image'].cast<String>()
        : null;
    if (json['handyman_staff'] != null) {
      handymanStaffList = json['handyman_staff'] != null
          ? (json['handyman_staff'] as List)
